...
<button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal">Add  New Officers </button>
</div>
...
<tbody>
    ...
    <tr>
        ...
        <td><?=$z['firstname']?></td>
        <td><?=$z['email']?></td>
        <td><?php if($z['is_admin']==1) { echo 'Admin';}else { echo 'User';} ?></td>
        <td>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Edit Officers information</h4>
      </div>
      <div class="modal-body">
									 ...
									 <input type='hidden' value='<?=$z['id']?>' name='id'>
										<div class="row mb-3">
											...
											<div class="col-sm-9">
												<input type="text" required name='name' class="form-control" value="<?=$z['firstname']?>" />
											</div>
										</div>
                    ...
                    <div class="row mb-3">
											...
											<div class="col-sm-9">
												<input type="email" required name='email' class="form-control" value="<?=$z['email']?>" />
											</div>
										</div>
                    ...
                    <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
											...
											<div class="col-sm-9">
                                                <select name='is_admin' required class='form-control'>
                                                    ...
                                                    <option  value='0' <?php if($z['is_admin']==0) {echo 'selected';} ?> >User</option>
                                                    <option  value='1' <?php if($z['is_admin']==1) {echo 'selected';} ?> > Admin</option>
                                        ...
                                        <div class="row mb-3">
											...
											<div class="col-sm-9">
                                                ...
                                                <select  name='zone[]' class="multiple-select" data-placeholder="Choose anything" multiple="multiple">
                                                    
<?php $zone=$this->db->get_where('n_zones',array('isdeleted'=>0,'status'=>1))->result_array();
foreach($zone as $xd){ ?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Add new Officers </h4>
      </div>
      <div class="modal-body">
       
      <?php echo form_open('officers-add',
                                     array('autocomplete'=>'off','method'=>'post',
                                     'class'=>'rojw g-j3','id' => 'mjy_id')); 
                                     ?>
