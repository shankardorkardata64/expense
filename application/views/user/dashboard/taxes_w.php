...
<button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal">Add  New Water Tax</button>
</div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Edit Water Tax</h4>
      </div>
      <div class="modal-body">
       


                                     <?php echo form_open('tax-update_w',
									 ...
									 <input type='hidden' value='<?=$z['id']?>' name='id'>
                                        ...
                                        <div class="row mb-3">
											...
											<div class="col-sm-9"> 	<input type="text" required name='priority' class="form-control" value="<?=$z['priority']?>" />
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Add new Water Tax</h4>
      </div>
      <div class="modal-body">
       
      <?php echo form_open('tax-add_w',
                                     array('autocomplete'=>'off','method'=>'post',
                                     'class'=>'rojw g-j3','id' => 'mjy_id')); 
                                     ?>
                                        ...
                                        <div class="row mb-3">
											...
											<div class="col-sm-9">
                      <input type="text" required name='priority' class="form-control" value="" />
