...
<?php echo form_open('',
                      ...
                      <h6 class="mb-0">Date From</h6>
												<input type="date" required name='from_w' class="form-control" value="<?php
                        
                        if($this->session->userdata('from_w')!=''){
                        echo date('Y-m-d',strtotime($this->session->userdata('from_w')));
                        }
                        ?>" />
											</div>
											...
											<div class="col-sm-3">
												...
												<input type="date" required name='to_w' class="form-control" value="<?php 
                         if($this->session->userdata('to_w')!=''){
                        echo date('Y-m-d',strtotime($this->session->userdata('to_w')));
                         }
                        ?>" />
											</div>
