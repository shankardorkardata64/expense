...
">
			...
			<p class="mb-0"><?=getsetting('system_footer')?></p>
		</footer> 
...
<script src="<?php asset('assets/plugins/datatable/js/jquery.dataTables.min.js') ?>"></script>
<script src="<?php asset('assets/plugins/datatable/js/dataTables.bootstrap5.min.js') ?>"></script>
